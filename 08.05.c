...
void main() {
	...
	printf(" \t  1. Paciente\n\t  2. Equipo medico\n\t  3. Personal de servicios\n \t  4. Administracion\n \t  5. Salir 6. Informar de un problema/aviso.\n\n");
	scanf_s("%d", &opcion);
	...
	case 4: printf("  Se ha identificado como PERSONAL DE ADMINISTRACION, ingrese:\n\n");
		...
		printf("\n   1. Ver historial de profesionales\n   2. Ver registros de pacientes   3. Registrar profesional   4. Registrar usuario   5. Avisos \n\n");
		scanf_s("%d", &opcion);
		getchar();
...
void crear_paciente() {
	...
	fopen_s(&crear_paciente,"pacienteshistorial.txt", "a"); //Si nolo que podemos hacer es un fichero que contenga todos los historiales de todos los pacientes y busque en el fichero el nombre del paciente y el medico escriba debajo
