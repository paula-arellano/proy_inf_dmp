...
;
	...
	case 5: printf("Indique a quien debera ir dirigido el aviso:\n   1. Limpieza\n   2. Lavanderia\n   3. Cocina\n   4. Mantenimiento\n\n");
		...
		case 1: 
			receptor[9] = "Limpieza";
			 char nombre_fichero[19] = "avisoslimpieza.txt";

			break;
		case 2:
			receptor[11] = "Lavanderia";
			char nombre_fichero[21] = "avisoslavanderia.txt";

			break;
		case 3:
			receptor[6] = "Cocina";
			char nombre_fichero[16] = "avisoscocina.txt";
			break;
		case 4:
			receptor[13] = "Mantenimiento";
			char nombre_fichero[23] = "avisosmantenimiento.txt";
			break;
		}*/
...
void identificacion() {
	...
	while (salir == 0) { // pide usuario hasta que sale uno correcto
		...
		/*fopen_s(&usuarios, "personalservicios.txt", "r");//abre el fichero cada vez*/
		printf("     Usuario: ");
